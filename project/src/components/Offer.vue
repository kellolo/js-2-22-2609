        ...
        <div class="offer__right">
          <article class="offer__services">
            <div class="offer__icon">
              <img src="../../src/assets/imgs/offer/offer_icon_1.svg" alt="#" />
            </div>
          ...
          <article class="offer__services">
            <div class="offer__icon">
              <img src="../../src/assets/imgs/offer/offer_icon_2.svg" alt="#" />
            </div>
            <div class="offer__text">
          ...
          <article class="offer__services">
            <div class="offer__icon">
              <img src="../../src/assets/imgs/offer/offer_icon_3.svg" alt="#" />
            </div>
            <div class="offer__text">
