<template>
  <div>
    <div class="page" id="page">
        ...
        <div class="header__left">
          <a href="" class="logo">
            ...
            /><span class="logo__text"
              >BRAN<span class="logo__text--last_letter">D</span></span
            >
          </a>
          <div class="header__form">
            <button class="header__browse" onclick="displayMenu()">
              Browse
            </button>
            <input
              class="header__input"
            ...
            <div id="mega_menu" class="mega_menu mega_menu--browse">
              <div class="mega_menu__column">
                ...
                <ul class="mega_menu__ul">
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Dresses</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Tops</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Sweaters/Knits</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Jackets/Coats</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Blazers</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Denim</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Leggings/Pants</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Skirts/Shorts</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Accessories</a>
                  </li>
                </ul>
                <h6 class="mega_menu__title mega_menu__title--middle">Men</h6>
                <ul class="mega_menu__ul">
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Tees/Tank tops</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Shirts/Polos</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Sweaters</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Sweatshirts/Hoodies</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Blazers</a>
                  </li>
                  <li class="mega_menu__list">
                    <a href="" class="mega_menu__link">Jackets/vests</a>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div id="basket-items">
                ...
                >
                  ...
                  <div class="drop__info">
                    ...
                    <img
                      src="../../src/assets/imgs/drop_cart/stars.png"
                      alt="#"
                    />
      ...
      <nav class="nav center">
        <ul class="menu">
          ...
          <li class="menu__list">
            ...
            <div class="mega_menu">
              ...
              <div class="mega_menu__column">
                ...
                <img
                  src="src/assets/imgs/src/assetssets/imgs/mega_menu.png"
                  alt="#"
                />
              </div>
            </div>
          ...
          <li class="menu__list">
            <a href="shoping_cart.html" class="menu__link">Women</a>
          </li>
          <li class="menu__list">
            <a href="product.html" class="menu__link">Kids</a>
          </li>
          <li class="menu__list">
            <a href="product.html" class="menu__link">Accoseriese</a>
          </li>
          <li class="menu__list">
      ...
      <section class="promo center">
        <div class="promo__content">
          ...
          <h2 class="promo__title">
            OF LUXERIOUS <span class="promo__title--last_letter">FASHION</span>
          </h2>
        </div>
      </section>
      <!-- PRODUCTS -->
      <section class="products center">
        <div class="products__left">
          <a class="products__item" href="#">
            <img
              class="products__img"
              src="https://raw.githubusercontent.com/Eliseev88/geekbrains/master/products/products_1.png"
              alt="#"
            />
          ...
          <a class="products__item" href="#">
            <img
              class="products__img"
              src="https://raw.githubusercontent.com/Eliseev88/geekbrains/master/products/products_3.png"
              alt="#"
            />
            <div class="products__content">
        ...
        <div class="products__right">
          <a class="products__item" href="#">
            <img
              class="products__img"
              src="https://raw.githubusercontent.com/Eliseev88/geekbrains/master/products/products_2.png"
              alt="#"
            />
            <div class="products__content">
          ...
          <a class="products__item" href="#">
            <img
              class="products__img"
              src="https://raw.githubusercontent.com/Eliseev88/geekbrains/master/products/products_4.png"
              alt="#"
            />
            <div class="products__content">
      ...
      <section class="offer center">
        <div class="offer__left">
          <img
            src="src/assets/imgs/src/assetssets/imgs/offer/offer_main.png"
            alt="#"
          />
          <div class="offer__content">
            <h2 class="offer_title">
              30% <span class="offer__last_word">OFFER</span>
            </h2>
        ...
        <div class="offer__right">
          <article class="offer__services">
            <div class="offer__icon">
              <img
                src="src/assets/imgs/src/assetssets/imgs/offer/offer_icon_1.svg"
                alt="#"
              />
            </div>
            <div class="offer__text">
              <div class="offer__sevrice_name">Free Delivery</div>
              <div class="offer__service_descript">
          ...
          <article class="offer__services">
            <div class="offer__icon">
              <img
                src="src/assets/imgs/src/assetssets/imgs/offer/offer_icon_2.svg"
                alt="#"
              />
            </div>
            <div class="offer__text">
          ...
          <article class="offer__services">
            <div class="offer__icon">
              <img
                src="src/assets/imgs/src/assetssets/imgs/offer/offer_icon_3.svg"
                alt="#"
              />
            </div>
            <div class="offer__text">
      ...
      <div class="subscribe">
        <div class="subscribe__inner center">
          <div class="subscribe__left">
            <img
              class="subscribe__avatar"
              src="src/assets/imgs/src/assetssets/imgs/subscribe/avatar.png"
              alt="#"
            />
    ...
    <div class="popup" id="popup">
      <button class="popup__close" id="close">
        <i class="fa fa-close"></i>
      </button>
      <div class="popup__wrapper">
        <button id="prev" class="popup__prev">
          <i class="fas fa-chevron-left"></i>
        </button>
        <img src="" alt="#" id="main-pic" class="popup__main" />
        <button id="next" class="popup__next">
