export default class Item {
    ...
    render() {
        switch (this.type) {
            ...
            case 'basket' : {
                return creteBasketItemTemplate(this.item)
            }
        }
    }
}
...
function creteBasketItemTemplate(item) {
    return ` <div class="drop_box" data-id="$item.productId}">
    <a class="drop_img" href="single.html"><img src="${item.productImg}" alt="#" width="72" height="85"></a>
    <div class="drop_info">
    <a href="single.html" class="drop_title">${item.productName}</a>
