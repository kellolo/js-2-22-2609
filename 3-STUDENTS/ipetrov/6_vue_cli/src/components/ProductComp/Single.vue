        ...
        <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner container">
                <div class="carousel-item active">
                    <img src="../../assets/additional_imgs/slide1.jpg" class="d-block" alt="slide1">
                </div>
                <div class="carousel-item">
                    <img src="../../assets/additional_imgs/slide1.jpg" class="d-block" alt="slide2">
                </div>
                <div class="carousel-item">
                    <img src="../../assets/additional_imgs/slide1.jpg" class="d-block" alt="slide3">
                </div>
            </div>
