...
<div class="header__left">
    <a href="" class="logo">
        <img class="logo__img" src="../../assets/imgs/logo.png" alt="logo"><span class="logo__text">BRAN<span class="logo__text--last_letter">D</span></span>
    </a>
    <div class="header__form">
        ...
        <button class="header__search"><img src="../../assets/imgs/search.png" alt="search"></button>
